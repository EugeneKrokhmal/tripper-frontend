                    ...
                    <Modal onClose={closeShareTripModal}>
                        {linkGenerated ? (
                            <>
                                ...
                                <h3 className="mb-2 text-2xl font-extrabold text-gray-900 dark:text-white md:text-2xl mt-4">
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('inviteFriends')}</span>
                                </h3>
                                <div className="relative w-full">
                                    <input
                                        id="share-trip-btn"
                                        type="text"
                                        className="pr-12 col-span-6 bg-gray-50 border border-gray-300 text-gray-500 dark:text-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        value={joinLink || ''}
                                        disabled
                                        readOnly
                                    />
                                    <button
                                        ...
                                        className="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-300  dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center"
                                    >
                                        {!copySuccess ? (
                                    ...
                                    <div id="tooltip-copy-share-trip-btn" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                ...
                                <div className="mt-4 flex gap-4">
                                    ...
                                    <button
                                        onClick={shareViaSMS}
                                        className="text-gray-500 dark:text-gray-300  hover:text-gray-600 dark:text-gray-300  underline"
                                    >
