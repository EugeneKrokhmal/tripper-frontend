        ...
        <div className="z-10 fixed top-16 left-0 right-0 mb-6 bg-white dark:bg-zinc-800 pt-4">
            <div className="w-full bg-white dark:bg-zinc-800 shadow">
                <div className="grid grid-cols-3 py-2 px-4 text-center">
                    <dl>
                        <dt className="text-xs font-normal text-zinc-500 dark:text-zinc-400 pb-1">{t('totalTripCost')}</dt>
                        <dd className="leading-none text-sm font-bold text-zinc-900 dark:text-white"><Price price={+totalCost.toFixed()} /></dd>
                    </dl>
                    <dl>
                        <dt className="text-xs font-normal text-zinc-500 dark:text-zinc-400 pb-1">{t('othersOwe')}</dt>
                    ...
                    <dl>
                        <dt className="text-xs font-normal text-zinc-500 dark:text-zinc-400 pb-1">{t('itCostsYou')}</dt>
