        ...
        <>
            ...
            <form onSubmit={handleSubmit} className="max-h-[70vh] overflow-y-auto">
                ...
                <div className="mt-6 mb-4">
                    <p className="text-xs text-gray-500 dark:text-gray-300 mb-2">{t('specificSplit')}</p>
                    <label className="inline-flex items-center cursor-pointer px-1">
                        ...
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{t('specificSplit')}</span>
                    </label>
                </div>

                {splitMethod === 'specific' && (
                    <div className="mb-6">
                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{t('splitAmong')}</label>
