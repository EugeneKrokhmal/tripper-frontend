    ...
    return (
        <div className="faq-container px-4 py-8 mx-auto max-w-7xl">
            ...
            <div className="faq-section mb-12">
                <h2 className="mb-2 text-4xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-4 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('faq.generalQuestions.title')}</h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="mb-2 text-4xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-4 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('faq.expensesAndSettlements.title')}</h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="mb-2 text-4xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-4 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('faq.paymentsAndFairShare.title')}</h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="mb-2 text-4xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-4 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('faq.accountAndPrivacy.title')}</h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="mb-2 text-4xl font-extrabold text-gray-900 dark:text-white md:text-3xl md:mt-4 text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{t('faq.technicalSupport.title')}</h2>
                <div>
