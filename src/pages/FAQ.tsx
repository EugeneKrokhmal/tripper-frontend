    ...
    return (
        <div className="faq-container px-4 py-8 mx-auto max-w-7xl">
            ...
            <div className="faq-section mb-12">
                <h2 className="text-2xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 dark:bg-gradient-to-r dark:from-purple-500 dark:to-pink-500">{t('faq.generalQuestions.title')}</span></h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="text-2xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 dark:bg-gradient-to-r dark:from-purple-500 dark:to-pink-500">{t('faq.expensesAndSettlements.title')}</span></h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="text-2xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 dark:bg-gradient-to-r dark:from-purple-500 dark:to-pink-500">{t('faq.paymentsAndFairShare.title')}</span></h2>
                <div>
            ...
            <div className="faq-section mb-12">
                <h2 className="text-2xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 dark:bg-gradient-to-r dark:from-purple-500 dark:to-pink-500">{t('faq.technicalSupport.title')}</span></h2>
                <div>
